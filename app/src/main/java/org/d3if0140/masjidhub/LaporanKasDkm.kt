...
import org.d3if0140.masjidhub.databinding.ActivityLaporanKasDkmBinding
import java.text.SimpleDateFormat
import java.util.Calendar
import java.util.Locale

class LaporanKasDkm : AppCompatActivity() {
    private lateinit var binding: ActivityLaporanKasDkmBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLaporanKasDkmBinding.inflate(layoutInflater)
