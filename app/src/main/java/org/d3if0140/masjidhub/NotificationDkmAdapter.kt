...
class NotificationDkmAdapter(private var notifications: MutableList<Notification>) :
    RecyclerView.Adapter<NotificationDkmAdapter.ViewHolder>() {
    ...
    private fun deleteNotification(position: Int) {
        ...
        db.collection("notifikasi_pengurus_dkm").document(notification.id)
            .delete()
