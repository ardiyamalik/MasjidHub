...
class LaporanPengajuanJamaah : AppCompatActivity() {
    private lateinit var binding: ActivityLaporanPengajuanJamaahBinding
    private lateinit var firestore: FirebaseFirestore
    private lateinit var selectedDateCalendar: Calendar
    private var totalPengajuan: Double = 0.0
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityLaporanPengajuanJamaahBinding.inflate(layoutInflater)
