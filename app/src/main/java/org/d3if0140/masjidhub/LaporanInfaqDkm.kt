...
import org.d3if0140.masjidhub.databinding.ActivityLaporanInfaqDkmBinding
import java.text.SimpleDateFormat
import java.util.Calendar
import java.util.Locale

class LaporanInfaqDkm : AppCompatActivity() {
    private lateinit var binding: ActivityLaporanInfaqDkmBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLaporanInfaqDkmBinding.inflate(layoutInflater)
        ...
        binding.backButton.setOnClickListener{
            intent = Intent(this, KeuanganDkmActivity::class.java)
